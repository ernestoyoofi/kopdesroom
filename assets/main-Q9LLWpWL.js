...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bs(e,t,n){let r=new Float32Array(Es),i=new U(0,1,0);return new xa({name:`SphericalGaussianBlur`,defines:{n:Es,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(){return new xa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new xa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Us(),fragmentShader:`
	...
	`}var Ws=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=sl(i,i.VERTEX_SHADER,y),S=sl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=pl(i,x,`vertex`),n=pl(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i])),this.transcoderBinary=n,this.workerPool.setWorkerCreator(()=>{let e=new Worker(this.workerSourceURL),t=this.transcoderBinary.slice(0);return e.postMessage({type:`init`,config:this.workerConfig,transcoderBinary:t},[t]),e})}),Zd>0&&console.warn(`THREE.KTX2Loader: Multiple active KTX2 loaders may cause performance issues. Use a single KTX2Loader instance, or call .dispose() on old instances.`),Zd++}return this.transcoderPending}load(e,t,n,r){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");let i=new $a(this.manager);i.setPath(this.path),i.setCrossOrigin(this.crossOrigin),i.setWithCredentials(this.withCredentials),i.setRequestHeader(this.requestHeader),i.setResponseType(`arraybuffer`),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");if(Xd.has(e))return Xd.get(e).promise.then(t).catch(n);this._createTexture(e).then(e=>t?t(e):null).catch(n)}_createTextureFrom(e,t){let{type:n,error:r,data:{faces:i,width:a,height:o,format:c,type:u,dfdFlags:d}}=e;if(n===`error`)return Promise.reject(r);let f;if(t.faceCount===6)f=new aa(i,c,u);else{let e=i[0].mipmaps;f=t.layerCount>1?new ia(e,a,o,t.layerCount,c,u):new ra(e,a,o,c,u)}return f.minFilter=i[0].mipmaps.length===1?s:l,f.magFilter=s,f.generateMipmaps=!1,f.needsUpdate=!0,f.colorSpace=af(t),f.premultiplyAlpha=!!(d&1),f}async _createTexture(e,t={}){let n=Vd(new Uint8Array(e)),r=n.vkFormat===1000066e3&&n.dataFormatDescriptor[0].colorModel===167;if(!(n.vkFormat===0||r&&!this.workerConfig.astcHDRSupported))return rf(n);let i=t,a=this.init().then(()=>this.workerPool.postMessage({type:`transcode`,buffer:e,taskConfig:i},[e])).then(e=>this._createTextureFrom(e.data,n));return Xd.set(e,{promise:a}),a}dispose(){this.workerPool.dispose(),this.workerSourceURL&&URL.revokeObjectURL(this.workerSourceURL),Zd--}};$d.BasisFormat={ETC1S:0,UASTC:1,UASTC_HDR:2},$d.TranscoderFormat={ETC1:0,ETC2:1,BC1:2,BC3:3,BC4:4,BC5:5,BC7_M6_OPAQUE_ONLY:6,BC7_M5:7,PVRTC1_4_RGB:8,PVRTC1_4_RGBA:9,ASTC_4x4:10,ATC_RGB:11,ATC_RGBA_INTERPOLATED_ALPHA:12,RGBA32:13,RGB565:14,BGR565:15,RGBA4444:16,BC6H:22,RGB_HALF:24,RGBA_HALF:25},$d.EngineFormat={RGBAFormat:T,RGBA_ASTC_4x4_Format:me,RGB_BPTC_UNSIGNED_Format:Ae,RGBA_BPTC_Format:Oe,RGBA_ETC2_EAC_Format:le,RGBA_PVRTC_4BPPV1_Format:oe,RGBA_S3TC_DXT5_Format:M,RGB_ETC1_Format:N,RGB_ETC2_Format:ce,RGB_PVRTC_4BPPV1_Format:ie,RGBA_S3TC_DXT1_Format:j},$d.EngineType={UnsignedByteType:u,HalfFloatType:_,FloatType:g},$d.BasisWorker=function(){let e,t,n,r=_EngineFormat,i=_EngineType,a=_TranscoderFormat,o=_BasisFormat;self.addEventListener(`message`,function(n){let r=n.data;switch(r.type){case`init`:e=r.config,s(r.transcoderBinary);break;case`transcode`:t.then(()=>{try{let{faces:e,buffers:t,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}=c(r.buffer);self.postMessage({type:`transcode`,id:r.id,data:{faces:e,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}},t)}catch(e){console.error(e),self.postMessage({type:`error`,id:r.id,error:e.message})}});break}});function s(e){t=new Promise(t=>{n={wasmBinary:e,onRuntimeInitialized:t},BASIS(n)}).then(()=>{n.initializeBasis(),n.KTX2File===void 0&&console.warn(`THREE.KTX2Loader: Please update Basis Universal transcoder.`)})}function c(e){let t=new n.KTX2File(new Uint8Array(e));function r(){t.close(),t.delete()}if(!t.isValid())throw r(),Error(`THREE.KTX2Loader:	Invalid or unsupported .ktx2 file`);let a;if(t.isUASTC())a=o.UASTC;else if(t.isETC1S())a=o.ETC1S;else if(t.isHDR())a=o.UASTC_HDR;else throw Error(`THREE.KTX2Loader: Unknown Basis encoding`);let s=t.getWidth(),c=t.getHeight(),l=t.getLayers()||1,u=t.getLevels(),f=t.getFaces(),m=t.getHasAlpha(),h=t.getDFDFlags(),{transcoderFormat:g,engineFormat:_,engineType:v}=d(a,s,c,m);if(!s||!c||!u)throw r(),Error(`THREE.KTX2Loader:	Invalid texture`);if(!t.startTranscoding())throw r(),Error(`THREE.KTX2Loader: .startTranscoding failed`);let y=[],b=[];for(let e=0;e<f;e++){let n=[];for(let a=0;a<u;a++){let o=[],s,c;for(let n=0;n<l;n++){let l=t.getImageLevelInfo(a,n,e);e===0&&a===0&&n===0&&(l.origWidth%4!=0||l.origHeight%4!=0)&&console.warn(`THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions.`),u>1?(s=l.origWidth,c=l.origHeight):(s=l.width,c=l.height);let d=new Uint8Array(t.getImageTranscodedSizeInBytes(a,n,0,g)),f=t.transcodeImage(d,a,n,e,g,0,-1,-1);if(v===i.HalfFloatType&&(d=new Uint16Array(d.buffer,d.byteOffset,d.byteLength/Uint16Array.BYTES_PER_ELEMENT)),!f)throw r(),Error(`THREE.KTX2Loader: .transcodeImage failed.`);o.push(d)}let d=p(o);n.push({data:d,width:s,height:c}),b.push(d.buffer)}y.push({mipmaps:n,width:s,height:c,format:_,type:v})}return r(),{faces:y,buffers:b,width:s,height:c,hasAlpha:m,dfdFlags:h,format:_,type:v}}let l=[{if:`astcSupported`,basisFormat:[o.UASTC],transcoderFormat:[a.ASTC_4x4,a.ASTC_4x4],engineFormat:[r.RGBA_ASTC_4x4_Format,r.RGBA_ASTC_4x4_Format],engineType:[i.UnsignedByteType],priorityETC1S:1/0,priorityUASTC:1,needsPowerOfTwo:!1},{if:`bptcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC7_M5,a.BC7_M5],engineFormat:[r.RGBA_BPTC_Format,r.RGBA_BPTC_Format],engineType:[i.UnsignedByteType],priorityETC1S:3,priorityUASTC:2,needsPowerOfTwo:!1},{if:`dxtSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC1,a.BC3],engineFormat:[r.RGBA_S3TC_DXT1_Format,r.RGBA_S3TC_DXT5_Format],engineType:[i.UnsignedByteType],priorityETC1S:4,priorityUASTC:5,needsPowerOfTwo:!1},{if:`etc2Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1,a.ETC2],engineFormat:[r.RGB_ETC2_Format,r.RGBA_ETC2_EAC_Format],engineType:[i.UnsignedByteType],priorityETC1S:1,priorityUASTC:3,needsPowerOfTwo:!1},{if:`etc1Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1],engineFormat:[r.RGB_ETC1_Format],engineType:[i.UnsignedByteType],priorityETC1S:2,priorityUASTC:4,needsPowerOfTwo:!1},{if:`pvrtcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.PVRTC1_4_RGB,a.PVRTC1_4_RGBA],engineFormat:[r.RGB_PVRTC_4BPPV1_Format,r.RGBA_PVRTC_4BPPV1_Format],engineType:[i.UnsignedByteType],priorityETC1S:5,priorityUASTC:6,needsPowerOfTwo:!0},{if:`bptcSupported`,basisFormat:[o.UASTC_HDR],transcoderFormat:[a.BC6H],engineFormat:[r.RGB_BPTC_UNSIGNED_Format],engineType:[i.HalfFloatType],priorityHDR:1,needsPowerOfTwo:!1},{basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.RGBA32,a.RGBA32],engineFormat:[r.RGBAFormat,r.RGBAFormat],engineType:[i.UnsignedByteType,i.UnsignedByteType],priorityETC1S:100,priorityUASTC:100,needsPowerOfTwo:!1},{basisFormat:[o.UASTC_HDR],transcoderFormat:[a.RGBA_HALF],engineFormat:[r.RGBAFormat],engineType:[i.HalfFloatType],priorityHDR:100,needsPowerOfTwo:!1}],u={[o.ETC1S]:l.filter(e=>e.basisFormat.includes(o.ETC1S)).sort((e,t)=>e.priorityETC1S-t.priorityETC1S),[o.UASTC]:l.filter(e=>e.basisFormat.includes(o.UASTC)).sort((e,t)=>e.priorityUASTC-t.priorityUASTC),[o.UASTC_HDR]:l.filter(e=>e.basisFormat.includes(o.UASTC_HDR)).sort((e,t)=>e.priorityHDR-t.priorityHDR)};function d(t,n,r,i){let a=u[t];for(let o=0;o<a.length;o++){let s=a[o];if(!(s.if&&!e[s.if])&&s.basisFormat.includes(t)&&!(i&&s.transcoderFormat.length<2)&&!(s.needsPowerOfTwo&&!(f(n)&&f(r))))return{transcoderFormat:s.transcoderFormat[+!!i],engineFormat:s.engineFormat[+!!i],engineType:s.engineType[0]}}throw Error(`THREE.KTX2Loader: Failed to identify transcoding target.`)}function f(e){return e<=2?!0:(e&e-1)==0&&e!==0}function p(e){if(e.length===1)return e[0];let t=0;for(let n=0;n<e.length;n++){let r=e[n];t+=r.byteLength}let n=new Uint8Array(t),r=0;for(let t=0;t<e.length;t++){let i=e[t];n.set(i,r),r+=i.byteLength}return n}};var ef=new Set([T,w,k,O]),tf={109:T,103:k,100:O,97:T,83:k,76:O,91:T,43:T,37:T,22:k,16:k,15:O,9:O,123:w,122:w,152:le,148:ce,153:ue,154:de,155:fe,156:pe,[Id]:me,158:me,157:me,[Ld]:ve,166:ve,165:ve,134:j,133:j,132:A,131:A,138:M,137:M,140:P,139:je,142:Ne,141:Me,146:Oe,145:Oe,[Fd]:oe,[Nd]:oe,[Pd]:se,[Md]:se},nf={109:g,103:g,100:g,97:_,83:_,76:_,91:p,43:u,37:u,22:u,16:u,15:u,9:u,123:x,122:S,152:u,148:u,153:u,154:u,155:u,156:u,[Id]:_,158:u,157:u,[Ld]:_,166:u,165:u,134:u,133:u,132:u,131:u,138:u,137:u,140:u,139:u,142:u,141:u,146:u,145:u,[Fd]:u,[Nd]:u,[Pd]:u,[Md]:u};async function rf(e){let{vkFormat:t}=e;if(tf[t]===void 0)throw Error(`THREE.KTX2Loader: Unsupported vkFormat: `+t);nf[t]===void 0&&console.warn(`THREE.KTX2Loader: Missing ".type" for vkFormat: `+t);let n;e.supercompressionScheme===2&&(Qd||=new Promise(async e=>{let t=new Kd;await t.init(),e(t)}),n=await Qd);let r=[];for(let i=0;i<e.levels.length;i++){let a=Math.max(1,e.pixelWidth>>i),o=Math.max(1,e.pixelHeight>>i),s=e.pixelDepth?Math.max(1,e.pixelDepth>>i):0,c=e.levels[i],l;if(e.supercompressionScheme===0)l=c.levelData;else if(e.supercompressionScheme===2)l=n.decode(c.levelData,c.uncompressedByteLength);else throw Error(`THREE.KTX2Loader: Unsupported supercompressionScheme.`);let u;u=nf[t]===1015?new Float32Array(l.buffer,l.byteOffset,l.byteLength/Float32Array.BYTES_PER_ELEMENT):nf[t]===1016||nf[t]===1012?new Uint16Array(l.buffer,l.byteOffset,l.byteLength/Uint16Array.BYTES_PER_ELEMENT):nf[t]===35902||nf[t]===35899?new Uint32Array(l.buffer,l.byteOffset,l.byteLength/Uint32Array.BYTES_PER_ELEMENT):l,r.push({data:u,width:a,height:o,depth:s})}let o=e.levelCount===0||r.length>1,c;if(ef.has(tf[t]))c=e.pixelDepth===0?new hi(r[0].data,e.pixelWidth,e.pixelHeight):new Zt(r[0].data,e.pixelWidth,e.pixelHeight,e.pixelDepth),c.minFilter=o?a:i,c.magFilter=i,c.generateMipmaps=e.levelCount===0;else{if(e.pixelDepth>0)throw Error(`THREE.KTX2Loader: Unsupported pixelDepth.`);c=new ra(r,e.pixelWidth,e.pixelHeight),c.minFilter=o?l:s,c.magFilter=s}return c.mipmaps=r,c.type=nf[t],c.format=tf[t],c.colorSpace=af(e),c.needsUpdate=!0,Promise.resolve(c)}function af(e){let t=e.dataFormatDescriptor[0];return t.colorPrimaries===1?t.transferFunction===2?Be:Ve:t.colorPrimaries===10?t.transferFunction===2?Jd:Yd:(t.colorPrimaries===0||console.warn(`THREE.KTX2Loader: Unsupported color primaries, "${t.colorPrimaries}"`),``)}var of=(function(){var e=`b9H79Tebbbe8Fv9Gbb9Gvuuuuueu9Giuuub9Geueu9Giuuueuixkbeeeddddillviebeoweuecj:Gdkr;:VZkdbk:XYi5ud9:du8Jjjjjbcj;kb9Rgv8Kjjjjbc9:hodnalTmbcuhoaiRbbgrc;WeGc:Ge9hmbarcsGgwce0mbc9:hoalcufadcd4cbawEgDadfgrcKcaawEgqaraq0Egk6mbaicefhxcj;abad9Uc;WFbGcjdadca0EhmaialfgPar9Rgoadfhsavaoadz:jjjjbgzceVhHcbhOdndninaeaO9nmeaPax9RaD6mdamaeaO9RaOamfgoae6EgAcsfglc9WGh
qpkbbabczfhbadclfgdae6mbxdkkaeTmbcbhdinabczfgkpxbFu9hbFu9hbFu9hbFu9habpbbbglakpbbbgrpmlvorxmPsCXQL358E8Fgvczp:TegqavcHp:Tep9qgicdp:Teaip9qgiclp:Teaip9qgicwp:Teaip9qgop;6ep;NegialarpmbediwDqkzHOAKY8AEgDpxFFbbFFbbFFbbFFbbglp9ograDczp:Segwp:Ueavczp:Reczp:SegDp:Xep;6ep;Mepxbbn0bbn0bbn0bbn0gvp;Kealp9oaiarawaDp:Uep:Xep;6ep;Meavp;Keczp:Rep9qgwaiaoaqcep:Rep9oaqpxebbbebbbebbbebbbp9op9qp;6ep;Meavp;Keczp:ReaiaDarp:Uep;6ep;Meavp;Kealp9op9qgipmwDKYqk8AExm35Ps8E8FpkbbabawaipmbezHdiOAlvCXorQLpkbbabcafhbadclfgdae6mbkkk9teiucbcbydj:G:cjbgeabcifc98GfgbBdj:G:cjbdndnabZbcztgd9nmbcuhiabad9RcFFifcz4nbcuSmekaehikaikkxebcj:Gdklz:zbb`,n=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,3,2,0,0,5,3,1,0,1,12,1,0,10,22,2,12,0,65,0,65,0,65,0,252,10,0,0,11,7,0,65,0,253,15,26,11]),r=new Uint8Array([32,0,65,2,1,106,34,33,3,128,11,4,13,64,6,253,10,7,15,116,127,5,8,12,40,16,19,54,20,9,27,255,113,17,42,67,24,23,146,148,18,14,22,45,70,69,56,114,101,21,25,63,75,136,108,28,118,29,73,115]);if(typeof WebAssembly!=`object`)return{supported:!1};var i=WebAssembly.validate(n)?s(t):s(e),a,o=WebAssembly.instantiate(i,{}).then(function(e){a=e.instance,a.exports.__wasm_call_ctors()});function s(e){for(var t=new Uint8Array(e.length),n=0;n<e.length;++n){var i=e.charCodeAt(n);t[n]=i>96?i-97:i>64?i-39:i+4}for(var a=0,n=0;n<e.length;++n)t[a++]=t[n]<60?r[t[n]]:(t[n]-60)*64+t[++n];return t.buffer.slice(0,a)}function c(e,t,n,r,i,a,o){var s=e.exports.sbrk,c=r+3&-4,l=s(c*i),u=s(a.length),d=new Uint8Array(e.exports.memory.buffer);d.set(a,u);var f=t(l,r,i,u,a.length);if(f==0&&o&&o(l,c,i),n.set(d.subarray(l,l+r*i)),s(l-s(0)),f!=0)throw Error(`Malformed buffer data: `+f)}var l={NONE:``,OCTAHEDRAL:`meshopt_decodeFilterOct`,QUATERNION:`meshopt_decodeFilterQuat`,EXPONENTIAL:`meshopt_decodeFilterExp`,COLOR:`meshopt_decodeFilterColor`},u={ATTRIBUTES:`meshopt_decodeVertexBuffer`,TRIANGLES:`meshopt_decodeIndexBuffer`,INDICES:`meshopt_decodeIndexSequence`},d=[],f=0;function p(e){var t={object:new Worker(e),pending:0,requests:{}};return t.object.onmessage=function(e){var n=e.data;t.pending-=n.count,t.requests[n.id][n.action](n.value),delete t.requests[n.id]},t}function m(e){for(var t=`self.ready = WebAssembly.instantiate(new Uint8Array([`+new Uint8Array(i)+`]), {}).then(function(result) { result.instance.exports.__wasm_call_ctors(); return result.instance; });self.onmessage = `+g.name+`;`+c.toString()+g.toString(),n=new Blob([t],{type:`text/javascript`}),r=URL.createObjectURL(n),a=d.length;a<e;++a)d[a]=p(r);for(var a=e;a<d.length;++a)d[a].object.postMessage({});d.length=e,URL.revokeObjectURL(r)}function h(e,t,n,r,i){for(var a=d[0],o=1;o<d.length;++o)d[o].pending<a.pending&&(a=d[o]);return new Promise(function(o,s){var c=new Uint8Array(n),l=++f;a.pending+=e,a.requests[l]={resolve:o,reject:s},a.object.postMessage({id:l,count:e,size:t,source:c,mode:r,filter:i},[c.buffer])})}function g(e){var t=e.data;self.ready.then(function(e){if(!t.id)return self.close();try{var n=new Uint8Array(t.count*t.size);c(e,e.exports[t.mode],n,t.count,t.size,t.source,e.exports[t.filter]),self.postMessage({id:t.id,count:t.count,action:`resolve`,value:n},[n.buffer])}catch(e){self.postMessage({id:t.id,count:t.count,action:`reject`,value:e})}})}return{ready:o,supported:!0,useWorkers:function(e){m(e)},decodeVertexBuffer:function(e,t,n,r,i){c(a,a.exports.meshopt_decodeVertexBuffer,e,t,n,r,a.exports[l[i]])},decodeIndexBuffer:function(e,t,n,r){c(a,a.exports.meshopt_decodeIndexBuffer,e,t,n,r)},decodeIndexSequence:function(e,t,n,r){c(a,a.exports.meshopt_decodeIndexSequence,e,t,n,r)},decodeGltfBuffer:function(e,t,n,r,i,o){c(a,a.exports[u[i]],e,t,n,r,a.exports[l[o]])},decodeGltfBufferAsync:function(e,t,n,r,i){return d.length>0?h(e,t,n,u[r],l[i]):o.then(function(){var o=new Uint8Array(e*t);return c(a,a.exports[u[r]],o,e,t,n,a.exports[l[i]]),o})}}})();window.isAppTauriRunning&&(document.querySelector(`.info-nomobilecontrol`)?.remove(),document.querySelector(`.help-overlay`)?.remove());var sf=35,cf=4/3,lf=`loading`,uf=0,df=0,ff=null,pf=null,mf=null,hf=45,gf=0,_f=0,vf=document.querySelector(`#game-canvas`);function yf(){let e=window.innerWidth,t=window.innerHeight,n=e,r=e/cf;return r>t&&(r=t,n=r*cf),{width:n,height:r}}var bf=yf(),xf=new Fn;xf.fog=new Pn(855306,.09);var Sf=new go(60,cf,.1,1e3),Cf=new En;Cf.add(Sf),xf.add(Cf);var Z={position:new U(0,1.6,0),height:1.6,radius:.6,walkSpeed:2.28,runSpeed:6.2,crouchSpeed:.8,velocity:new U,acceleration:10,friction:6};Cf.position.copy(Z.position);var wf=new Ou({canvas:vf,antialias:!1});wf.setSize(bf.width,bf.height),wf.setPixelRatio(1),wf.shadowMap.enabled=!0,wf.shadowMap.type=1,wf.toneMapping=4,wf.toneMappingExposure=2.43;var Tf=new $d().setTranscoderPath(`/basis/`).detectSupport(wf),Ef=new Yt(bf.width,bf.height),Df=new wo(16777215,1.4);xf.add(Df);var Of=new vo(16777215,8,35,Math.PI/3.8,.6,1);Of.castShadow=!0,Of.shadow.mapSize.width=256,Of.shadow.mapSize.height=256,Of.shadow.camera.near=.5,Of.shadow.camera.far=35,Of.shadow.bias=-.004,xf.add(Of),xf.add(Of.target);var kf=new Co(16777215,.5);kf.position.set(0,5,0),kf.castShadow=!0,kf.shadow.mapSize.width=256,kf.shadow.bias=-.004,xf.add(kf);var Af=new Ho;Sf.add(Af);var jf=new Uo(Af),Mf=[],Nf=null,Pf=new Ao,Ff=null,If=null,Lf=null,Rf=null,zf=[],Bf=0,Vf=0,Hf=new Map,Uf=!1,Wf=null,Gf=null,Kf=null,qf=null,Jf=60+Math.random()*60,Yf=`idle`,Xf=0,Zf=new U,Qf=30+Math.random()*45,$f=!1,ep=null,tp=0,np=document.createElement(`canvas`);np.width=512,np.height=512;var Q=np.getContext(`2d`),rp=new sa(np);rp.minFilter=s;var ip=0;function ap(e){if(Q.clearRect(0,0,np.width,np.height),Q.shadowColor=`rgba(0, 0, 0, 0.85)`,Q.shadowBlur=4,Q.shadowOffsetX=2,Q.shadowOffsetY=2,Q.font=`bold 24px 'JetBrains Mono', monospace`,Q.textAlign=`center`,Q.fillStyle=`#ffffff`,lf===`loading`)Q.font=`bold 28px 'JetBrains Mono', monospace`,Q.fillText(`LOADING...`,256,210),Q.font=`16px 'JetBrains Mono', monospace`,Q.fillStyle=`#88887c`,Q.fillText(`${ip}%`,256,240),Q.shadowColor=`transparent`,Q.strokeStyle=`#444438`,Q.lineWidth=2,Q.strokeRect(136,260,240,8),Q.fillStyle=`#ffffff`,Q.fillRect(136,260,ip/100*240,8);else if(lf===`voice-setup`){Q.fillText(`MICROPHONE CONFIGURATION`,256,110),Q.font=`13px 'JetBrains Mono', monospace`,Q.fillStyle=`#88887c`,Q.fillText(`Adjust threshold limit to balance voice load`,256,140),Q.shadowColor=`transparent`;for(let e=0;e<34;e++){let t=e/34*100,n=120+e*8;gf>=t?t>hf?Q.fillStyle=`#ff3333`:Q.fillStyle=`#ffffff`:Q.fillStyle=`#22221b`,Q.fillRect(n,180,5,22)}let t=120+hf/100*269;if(Q.strokeStyle=`#ffaa00`,Q.lineWidth=2,Q.beginPath(),Q.moveTo(t,172),Q.lineTo(t,210),Q.stroke(),Q.shadowColor=`rgba(0, 0, 0, 0.85)`,Q.font=`bold 15px 'JetBrains Mono', monospace`,Q.fillStyle=`#ffffff`,Q.fillText(`LIMIT LOAD THRESHOLD: ${hf}%`,256,245),Q.font=`13px 'JetBrains Mono', monospace`,gf>hf){let e=Math.floor(Math.random()*200)+200;Q.fillStyle=`#ff3333`,Q.fillText(`CURRENT LOAD: ${e}ms - CRITICAL OVERFLOW!`,256,275)}else Q.fillStyle=`#33ff33`,Q.fillText(`CURRENT LOAD: ${Math.max(12,Math.round(gf*.4))}ms - NOMINAL`,256,275);Q.font=`12px 'JetBrains Mono', monospace`,Q.fillStyle=`#a8a89c`,Q.fillText(`Press [-] to Decrease | [+] to Increase`,256,310);let n=Math.sin(e*.006)>0;Q.font=`bold 15px 'JetBrains Mono', monospace`,Q.fillStyle=n?`#ffffff`:`#444438`,Q.fillText(`[ PRESS ENTER TO CONNECT CAMERA ]`,256,370)}else if(lf===`paused`){Q.font=`bold 36px 'JetBrains Mono', monospace`,Q.fillStyle=`#ffaa00`,Q.fillText(`PAUSED`,256,180),Q.font=`16px 'JetBrains Mono', monospace`,Q.fillStyle=`#88887c`,Q.fillText(`SURVIVED TIME: ${Math.round(uf)}s`,256,220),Q.fillText(`GAME IS TEMPORARILY PAUSED`,256,245),Q.font=`bold 22px 'JetBrains Mono', monospace`,Q.fillStyle=`#ffffff`,Q.fillText(`[Screen!] Resume`,256,290),Q.fillText(`[M] ${Uf?`Unmute`:`Mute`} Audio`,256,320);let t=Math.sin(e*.006)>0;Q.font=`bold 15px 'JetBrains Mono', monospace`,Q.fillStyle=t?`#ffffff`:`#444438`,Q.fillText(`Click screen to resume`,256,380)}else if(lf===`gameover`){Q.font=`bold 36px 'JetBrains Mono', monospace`,Q.fillStyle=`#ff3333`,Q.fillText(`Disconnecting`,256,180),Q.font=`16px 'JetBrains Mono', monospace`,Q.fillStyle=`#88887c`,Q.fillText(`CRITICAL SIGNAL LOAD OVERFLOW (200ms-400ms)`,256,220),Q.font=`bold 20px 'JetBrains Mono', monospace`,Q.fillStyle=`#ffffff`,Q.fillText(`SURVIVED TIME: ${df}s`,256,270);let t=Math.sin(e*.006)>0;Q.font=`bold 15px 'JetBrains Mono', monospace`,Q.fillStyle=t?`#ffffff`:`#333333`,Q.fillText(`Please hit ENTER to restart game`,256,360)}rp.needsUpdate=!0}var op=!1;document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===vf?(op=!0,lf===`paused`&&(lf=`playing`,jf.setVolume(Uf?0:.4),Nf&&Nf.setVolume(Uf?0:.5))):(op=!1,fp=0,pp=0,lf===`playing`&&(lf=`paused`,jf.setVolume(.08),Nf&&Nf.setVolume(.08)))}),vf.addEventListener(`click`,()=>{(lf===`playing`||lf===`paused`)&&vf.requestPointerLock()});var sp=new At,cp=0,lp=0,up=0,dp=0,fp=0,pp=0;document.addEventListener(`mousemove`,e=>{!op||lf!==`playing`||(cp-=e.movementX*.002,lp-=e.movementY*.002,lp=Math.max(-Math.PI/2.2,Math.min(Math.PI/2.2,lp)),fp+=Math.abs(e.movementX)*.2,pp+=Math.abs(e.movementY)*.2)});var mp=!0;vf.addEventListener(`mousedown`,e=>{if(lf===`playing`&&op&&e.button===0){mp=!mp,Of.visible=mp;let e=new Uo(Af);e.setBuffer(mp?Lf:Rf),e.setVolume(.7),e.play()}});var hp=60,gp=60;vf.addEventListener(`wheel`,e=>{lf===`playing`&&(e.preventDefault(),gp+=e.deltaY*.05,gp=Math.max(12,Math.min(60,gp)))},{passive:!1});var $={w:!1,a:!1,s:!1,d:!1,q:!1,e:!1,shift:!1,c:!1,x:!1},_p=0,vp=0,yp=0,bp=0;window.addEventListener(`keydown`,e=>{if(lf===`voice-setup`){(e.key===`-`||e.key===`_`)&&(hf=Math.max(10,hf-5)),(e.key===`+`||e.key===`=`)&&(hf=Math.min(95,hf+5)),e.key===`Enter`&&(lf=`playing`,Ip());return}if(lf===`gameover`&&e.key===`Enter`){Gp();return}if(e.key.toLowerCase()===`m`){Uf=!Uf;let e=Uf?0:.5;jf.setVolume(Uf?0:.4),Nf&&Nf.setVolume(e)}let t=e.key.toLowerCase();t===`shift`?($.shift=!0,$.x&&=!1):t in $&&($[t]=!0)}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();t===`shift`?$.shift=!1:t in $&&($[t]=!1)});function xp(){navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(e=>{ff=new(window.AudioContext||window.webkitAudioContext);let t=ff.createMediaStreamSource(e);pf=ff.createAnalyser(),pf.fftSize=256,mf=new Uint8Array(pf.frequencyBinCount),t.connect(pf),lf=`voice-setup`,Fp()}).catch(e=>{alert(`ALERT! Game ini wajib mengaktifkan izin Microphone untuk bermain!`),console.error(`Izin mic ditolak:`,e)})}function Sp(e){if(!pf)return;pf.getByteFrequencyData(mf);let t=0;for(let e=0;e<mf.length;e++)t+=mf[e];let n=t/mf.length;gf=Math.min(Math.round(n/128*100),100),lf===`playing`&&(gf>hf?(_f+=e*1e3,_f>=270&&Wp()):_f=kt.lerp(_f,0,.1))}var Cp=20,wp=new Map,Tp=[],Ep=[],Dp=new Mu;Dp.setKTX2Loader(Tf),Dp.setMeshoptDecoder(of);var Op=new cs,kp={1:null,2:null,3:null,4:null},Ap=new Map,jp=6,Mp=0;function Np(){let e=0;Ap.forEach(t=>{e+=t}),Hf.forEach(t=>{e+=t});let t=jp+Bf;ip=Math.min(Math.round(e/t),100),Mp>=jp&&Vf>=Bf&&lf===`loading`&&xp()}function Pp(){[{id:1,url:`/models/room1.glb`},{id:2,url:`/models/room2.glb`},{id:3,url:`/models/room3.glb`},{id:4,url:`/models/room4.glb`},{id:`solo`,url:`/models/scp-solo02.glb`},{id:`falling`,url:`/models/scp-opgmbg01.glb`}].forEach(e=>{Ap.set(e.id,0),Dp.load(e.url,t=>{typeof e.id==`number`?kp[e.id]=t.scene:e.id===`solo`?(Wf=t.scene,Wf.visible=!1,xf.add(Wf)):e.id===`falling`&&(Gf=t.scene),Mp++,Ap.set(e.id,100),Np()},t=>{t.total>0&&(Ap.set(e.id,t.loaded/t.total*100),Np())},e=>console.error(`Load gagal:`,e))});let e=[{name:`noise`,url:`/bg/bg-noise-backroom.mp3`},{name:`song-0`,url:`/bg/bg-song-daise.mp3`},{name:`fsLeft`,url:`/sfx/footstep-left.mp3`},{name:`fsRight`,url:`/sfx/footstep-right.mp3`},{name:`flashOn`,url:`/sfx/flashlight-on.mp3`},{name:`flashOff`,url:`/sfx/flashlight-off.mp3`},{name:`amb1`,url:`/ambiences/banyak-negara-yang-panik-indonesia-masih-ok.mp3`},{name:`amb2`,url:`/ambiences/desa-ga-pakai-dolar.mp3`},{name:`jumpscare`,url:`/sfx/jumpscare-wokaget.mp3`},{name:`metal`,url:`/sfx/hit-metal-falling.mp3`}];Bf=e.length,e.forEach((e,t)=>{Hf.set(t,0),Pf.load(e.url,n=>{if(t===0)jf.setBuffer(n);else if(e.name.startsWith(`song-`)){let e=new Uo(Af);e.setBuffer(n),Mf.push(e)}else e.name===`fsLeft`?Ff=n:e.name===`fsRight`?If=n:e.name===`flashOn`?Lf=n:e.name===`flashOff`?Rf=n:e.name===`amb1`?zf[0]=n:e.name===`amb2`?zf[1]=n:e.name===`jumpscare`?Kf=n:e.name===`metal`&&(qf=n);Vf++,Hf.set(t,100),Np()},e=>{e.total>0&&(Hf.set(t,e.loaded/e.total*100),Np())})})}function Fp(){Mf.length!==0&&(Nf&&Nf.stop(),Nf=Mf[Math.floor(Math.random()*Mf.length)],Nf.setLoop(!0),Nf.setVolume(Uf?0:.5),Nf.play())}function Ip(){setTimeout(()=>{vf.requestPointerLock()},200),uf=0,_f=0,jf.setLoop(!0),jf.setVolume(.4),jf.play(),!Nf||!Nf.isPlaying?Fp():Nf.setVolume(Uf?0:.5),Lp(0,0),Lp(1,0),Lp(-1,0),Lp(0,1),Lp(0,-1)}function Lp(e,t){let n=`${e},${t}`;if(wp.has(n))return;let r=new En;r.position.set(e*Cp,0,t*Cp),xf.add(r),wp.set(n,{group:r,loaded:!0});let i=Math.sin(e*12.9898+t*78.233)*43758.5453123,a=i-Math.floor(i),o=kp[Math.floor(a*4)+1];if(!o)return;let s=o.clone();r.add(s),s.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material&&(e.material.roughness=Math.max(e.material.roughness,.5)),e.name.toLowerCase().includes(`floor`)||e.name.toLowerCase().includes(`lantai`)?(e.material&&(e.material.roughness=.05,e.material.metalness=.1),Ep.push(e)):Tp.push(e))}),e===0&&t===0&&Up()}function Rp(){if(lf!==`playing`)return;let e=Math.round(Z.position.x/Cp),t=Math.round(Z.position.z/Cp);for(let n=-1;n<=1;n++)for(let r=-1;r<=1;r++)Math.abs(n)+Math.abs(r)<=1&&Lp(e+n,t+r);wp.forEach((n,r)=>{let[i,a]=r.split(`,`).map(Number),o=Math.abs(i-e)+Math.abs(a-t);o>=3?(xf.remove(n.group),n.group.traverse(e=>{if(e.isMesh){let t=Tp.indexOf(e);t>-1&&Tp.splice(t,1);let n=Ep.indexOf(e);n>-1&&Ep.splice(n,1),e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}}),wp.delete(r)):o===2?n.group.visible=!1:n.group.visible=!0})}Pp();var zp=new xa({uniforms:{tDiffuse:{value:null},tHUD:{value:rp},uTime:{value:0},uBlurIntensity:{value:0},uScreenState:{value:0}},vertexShader:`
  ...
  `}),Bp=new Fn,Vp=new xo(-1,1,1,-1,0,1),Hp=new ti(new fa(2,2),zp);Bp.add(Hp);function Up(){zp.uniforms.uScreenState.value!==1&&setTimeout(()=>{zp.uniforms.uScreenState.value=1,fp=4,pp=4},400)}function Wp(){lf=`gameover`,df=Math.round(uf),jf.stop(),Nf&&Nf.stop(),document.exitPointerLock(),Sf.rotation.set(Math.PI/2.3,0,Math.PI/4),Cf.position.y=Z.position.y-1.45,setTimeout(()=>{zp.uniforms.uScreenState.value=0},350)}function Gp(){wp.forEach(e=>xf.remove(e.group)),wp.clear(),Tp.length=0,Ep.length=0,Z.position.set(0,1.6,0),Z.velocity.set(0,0,0),Cf.position.copy(Z.position),Sf.rotation.set(0,0,0),cp=0,lp=0,up=0,dp=0,Cf.rotation.set(0,0,0),im=0,am=0,om=0,sm=0,cm=0,lm=1,vm=0,ym=30+Math.random()*60,_p=0,vp=0,yp=0,bp=0,$.c=!1,$.x=!1,mp=!0,Of.visible=!0,hp=60,gp=60,Sf.fov=60,Sf.updateProjectionMatrix(),zp.uniforms.uScreenState.value=0,lf=`voice-setup`}function Kp(e){if(!op||lf!==`playing`)return;let t=$.c?Z.crouchSpeed:$.shift?Z.runSpeed:Z.walkSpeed,n=new U(0,0,-1).applyQuaternion(Cf.quaternion),r=new U(1,0,0).applyQuaternion(Cf.quaternion);n.y=0,n.normalize(),r.y=0,r.normalize();let i=0,a=0;$.w&&(i+=n.x,a+=n.z),$.s&&(i-=n.x,a-=n.z),$.d&&(i+=r.x,a+=r.z),$.a&&(i-=r.x,a-=r.z);let o=Math.sqrt(i*i+a*a);if(o>.001){i/=o,a/=o,Z.velocity.x+=i*Z.acceleration*e,Z.velocity.z+=a*Z.acceleration*e;let n=Math.sqrt(Z.velocity.x**2+Z.velocity.z**2);n>t&&(Z.velocity.x*=t/n,Z.velocity.z*=t/n),fp+=$.shift?.35:.18}else{let t=Math.sqrt(Z.velocity.x**2+Z.velocity.z**2);if(t>0){let n=Z.friction*e;if(n>=t)Z.velocity.x=0,Z.velocity.z=0;else{let e=(t-n)/t;Z.velocity.x*=e,Z.velocity.z*=e}}}let s=Z.position.clone();s.x+=Z.velocity.x*e,s.z+=Z.velocity.z*e;let c=!0,l=!0;if(Math.sqrt(Z.velocity.x**2+Z.velocity.z**2)>.001&&Tp.length>0){let e=new U(Z.position.x,Z.position.y-.5,Z.position.z);Op.set(e,new U(Z.velocity.x,0,0).normalize());let t=Op.intersectObjects(Tp);t.length>0&&t[0].distance<Z.radius&&(c=!1),Op.set(e,new U(0,0,Z.velocity.z).normalize());let n=Op.intersectObjects(Tp);n.length>0&&n[0].distance<Z.radius&&(l=!1)}c?Z.position.x=s.x:Z.velocity.x=0,l?Z.position.z=s.z:Z.velocity.z=0}var qp=0,Jp=!0;function Yp(){let e=Jp?Ff:If;if(!e)return;let t=new Uo(Af);t.setBuffer(e),t.setVolume($.shift&&!$.c?.65:.45),t.play(),Jp=!Jp}function Xp(e){let t=$.w||$.a||$.s||$.d;if(!op||!t||lf!==`playing`){qp=0;return}let n=$.shift&&!$.c?.22:.38;qp+=e,qp>=n&&(qp=0,Yp())}var Zp=0,Qp=0,$p=0,em=0,tm=0,nm=0,rm=0,im=0,am=0,om=0,sm=0,cm=0,lm=1,um=0,dm=.38,fm=0,pm=0,mm=1,hm=0;function gm(e){if(lf!==`playing`)return;_p=$.c?-.8:0,vp=kt.lerp(vp,_p,.08),yp=$.x?.35:0,bp=kt.lerp(bp,yp,.08);let t=($.w||$.a||$.s||$.d)&&op,n=$.shift&&t&&!$.c;fm=kt.lerp(fm,+!!t,.08),pm=kt.lerp(pm,+!!n,.06);let r=n?.22:.38;dm=kt.lerp(dm,r,.1),um+=e;let i=Math.PI/dm;Zp+=e*i*fm;let a=Zp,o=um*1.5,s=(Math.sin(um*15.1)*.4+Math.sin(um*27.3)*.3+Math.sin(um*41.7)*.2)*.002,c=(Math.sin(um*17.2)*.4+Math.sin(um*23.1)*.3+Math.sin(um*37.1)*.2)*.002,l=(Math.sin(o*.7)*.5+Math.sin(o*1.3)*.3)*.03,u=(Math.cos(o*.6)*.5+Math.sin(o*1.1)*.3)*.03,d=(Math.sin(o*.5)*.5+Math.cos(o*.9)*.3)*.02,f=(.04+pm*.05)*fm,p=(.08+pm*.12)*fm,m=(.02+pm*.08)*fm,h=(.03+pm*.04)*fm,g=Math.cos(a*.5)*f,_=Math.abs(Math.sin(a))**2.2*p,v=Math.sin(a*.5)*m,y=Math.cos(a)*h,b=cp-up;b=Math.atan2(Math.sin(b),Math.cos(b));let x=Math.PI/180*14,S=Math.max(-x,Math.min(x,-b*3.5));hm=kt.lerp(hm,S,.1);let C=l+g+s,w=u+_+c;if(pm>.1){let e=Math.sin(a*2)*Math.cos(a*.5);w+=e*.08*pm,C+=Math.cos(a*2.5)*.05*pm}let T=d+v+hm+s*2.5,E=y+c*2.5;Qp=kt.lerp(Qp,C,.12),$p=kt.lerp($p,w,.12),em=kt.lerp(em,T,.12),tm=kt.lerp(tm,E,.12);let D=Math.abs(Math.sin(a))**8*(.02+pm*.03)*fm;Sf.rotation.y=kt.lerp(Sf.rotation.y,Math.sin(a*.5)*.015*fm+l*.5,.05),Sf.rotation.x=kt.lerp(Sf.rotation.x,dp+tm+D,.25);let O=0,ee=0;if(op){if($.q?(om=-1.1,sm=.52,cm=.2,lm=1):$.e&&(om=1.1,sm=-.52,cm=.2,lm=1),$.q||$.e)O=om,ee=sm;else if(om!==0||sm!==0)if(cm>0)cm-=e,O=om,ee=sm;else{lm=Math.max(0,lm-e*3);let t=1-(1-(1-lm))**3;O=kt.lerp(0,om,1-t),ee=kt.lerp(0,sm,1-t),lm<=0&&(om=0,sm=0,lm=1)}}nm=kt.lerp(nm,O,.1),rm=kt.lerp(rm,ee,.1);let k=new U(Qp+nm,$p-.05,0).applyQuaternion(Cf.quaternion),te=Z.position.clone(),ne=k.clone().normalize(),A=k.length(),j=1;if(A>.01&&Tp.length>0){Op.set(te,ne);let e=Op.intersectObjects(Tp);e.length>0&&e[0].distance<A+.25&&(j=Math.max(0,(e[0].distance-.25)/A))}mm=kt.lerp(mm,j,.15),k.multiplyScalar(mm),Cf.position.copy(Z.position).add(k),Cf.position.y+=vp+bp,Sf.rotation.z=em+rm+(Math.random()-.5)*.001}function _m(e){if(lf===`playing`){if(Yf===`idle`){if(Jf-=e,Jf<=0&&(Yf=`flicker`,Xf=0,!mp)){mp=!0,Of.visible=!0;let e=new Uo(Af);e.setBuffer(Lf),e.setVolume(.7),e.play()}}else if(Yf===`flicker`)Xf+=e,Xf<.3?Of.visible=!0:Xf<.6?Of.visible=!1:Xf<.9?Of.visible=!0:Xf<1.2?Of.visible=!1:(Of.visible=!0,Yf=`waiting`,Xf=0);else if(Yf===`waiting`){if(Xf+=e,Xf>=3){Yf=`rushing`,Xf=0;let e=new U(0,0,-1).applyQuaternion(Sf.getWorldQuaternion(new At));if(e.y=0,e.normalize(),Wf&&(Wf.position.copy(Z.position).add(e.clone().multiplyScalar(8)),Wf.position.y=0,Wf.lookAt(Z.position.x,0,Z.position.z),Wf.visible=!0,Zf.copy(e).negate().normalize()),Kf){let e=new Uo(Af);e.setBuffer(Kf),e.setVolume(1),e.play()}}}else Yf===`rushing`&&(Xf+=e,Wf&&Wf.position.add(Zf.clone().multiplyScalar(e*24)),Xf>=1&&(Wf&&(Wf.visible=!1),Yf=`idle`,Jf=60+Math.random()*120));if(!$f){if(Qf-=e,Qf<=0&&($f=!0,Qf=30+Math.random()*60,Gf)){ep=Gf.clone(),ep.name=`falling_scp_instance`;let e=Math.random()*Math.PI*2,t=3+Math.random()*5;ep.position.set(Z.position.x+Math.cos(e)*t,5,Z.position.z+Math.sin(e)*t),xf.add(ep),tp=0}}else if(ep&&(tp+=9.8*e,ep.position.y-=tp*e,ep.position.y<=.2)){if(ep.position.y=.2,$f=!1,qf){let e=new Uo(Af);e.setBuffer(qf),e.setVolume(.8),e.play()}ep=null}xf.children.forEach(e=>{e.name===`falling_scp_instance`&&Z.position.distanceTo(e.position)>35&&xf.remove(e)})}}var vm=0,ym=30+Math.random()*60;function bm(e){if(lf!==`playing`||Uf||(vm+=e,vm<ym)||(vm=0,ym=30+Math.random()*60,zf.length===0))return;let t=zf[Math.floor(Math.random()*zf.length)];if(!t)return;let n=Z.position.x,r=Z.position.z;if(wp.size>0){let e=Math.round(Z.position.x/Cp),t=Math.round(Z.position.z/Cp),i=[];for(let n of wp.keys()){let[r,a]=n.split(`,`).map(Number);(r!==e||a!==t)&&i.push(n)}if(i.length>0){let[e,t]=i[Math.floor(Math.random()*i.length)].split(`,`).map(Number);n=e*Cp+(Math.random()-.5)*Cp*.7,r=t*Cp+(Math.random()-.5)*Cp*.7}else n+=(Math.random()-.5)*20,r+=(Math.random()-.5)*20}let i=new Jo(Af);i.setBuffer(t),i.setRefDistance(12),i.setRolloffFactor(.8),i.setVolume(2.4),i.position.set(n,1.5,r),xf.add(i),i.play(),i.onEnded=()=>xf.remove(i)}var xm=1e3/sf,Sm=performance.now(),Cm=performance.now();function wm(){requestAnimationFrame(wm);let e=performance.now(),t=e-Sm;if(t>xm){Sm=e-t%xm;let n=Math.min((e-Cm)/1e3,.1);if(Cm=e,lf!==`loading`&&Sp(n),lf===`playing`){uf+=n,Kp(n),gm(n);let e=cp-up;e=Math.atan2(Math.sin(e),Math.cos(e)),up+=e*.2,dp=kt.lerp(dp,lp,.2),Cf.rotation.y=up,hp=kt.lerp(hp,gp,.24),Sf.fov=hp,Sf.updateProjectionMatrix();let t=(60-hp)/48;Of.intensity=8+t*15,Of.angle=Math.PI/3.8*(1-t*.4),Of.distance=35+t*35,Of.penumbra=.6+t*.4,fp*=.96,pp*=.96,Xp(n),_m(n),bm(n),Rp()}else ap(e);let r=new U,i=new At;Sf.getWorldPosition(r),Sf.getWorldQuaternion(i),Of.position.copy(r),sp.slerp(i,.12);let a=new U(0,0,-1).applyQuaternion(sp);Of.target.position.copy(r).add(a),zp.uniforms.uTime.value=e*.001%10,zp.uniforms.uBlurIntensity.value=Math.min(fp+pp,2),zp.uniforms.uScreenState.value=+(lf===`playing`),wf.setRenderTarget(Ef),wf.render(xf,Sf),wf.setRenderTarget(null),zp.uniforms.tDiffuse.value=Ef.texture,wf.render(Bp,Vp)}}window.addEventListener(`resize`,()=>{let e=yf();wf.setSize(e.width,e.height),Ef.setSize(e.width,e.height)}),wm();