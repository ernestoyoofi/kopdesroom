...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zs(e,t,n){let r=new Float32Array(Ts),i=new W(0,1,0);return new ba({name:`SphericalGaussianBlur`,defines:{n:Ts,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Hs(),fragmentShader:`
...
`)}var ml={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function hl(e,t){let n=ml[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var gl=new W;function _l(){return K.getLuminanceCoefficients(gl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${gl.x.toFixed(4)}, ${gl.y.toFixed(4)}, ${gl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i])),this.transcoderBinary=n,this.workerPool.setWorkerCreator(()=>{let e=new Worker(this.workerSourceURL),t=this.transcoderBinary.slice(0);return e.postMessage({type:`init`,config:this.workerConfig,transcoderBinary:t},[t]),e})}),Xd>0&&console.warn(`THREE.KTX2Loader: Multiple active KTX2 loaders may cause performance issues. Use a single KTX2Loader instance, or call .dispose() on old instances.`),Xd++}return this.transcoderPending}load(e,t,n,r){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");let i=new Qa(this.manager);i.setPath(this.path),i.setCrossOrigin(this.crossOrigin),i.setWithCredentials(this.withCredentials),i.setRequestHeader(this.requestHeader),i.setResponseType(`arraybuffer`),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");if(Yd.has(e))return Yd.get(e).promise.then(t).catch(n);this._createTexture(e).then(e=>t?t(e):null).catch(n)}_createTextureFrom(e,t){let{type:n,error:r,data:{faces:i,width:a,height:o,format:c,type:u,dfdFlags:d}}=e;if(n===`error`)return Promise.reject(r);let f;if(t.faceCount===6)f=new ia(i,c,u);else{let e=i[0].mipmaps;f=t.layerCount>1?new ra(e,a,o,t.layerCount,c,u):new na(e,a,o,c,u)}return f.minFilter=i[0].mipmaps.length===1?s:l,f.magFilter=s,f.generateMipmaps=!1,f.needsUpdate=!0,f.colorSpace=rf(t),f.premultiplyAlpha=!!(d&1),f}async _createTexture(e,t={}){let n=Bd(new Uint8Array(e)),r=n.vkFormat===1000066e3&&n.dataFormatDescriptor[0].colorModel===167;if(!(n.vkFormat===0||r&&!this.workerConfig.astcHDRSupported))return nf(n);let i=t,a=this.init().then(()=>this.workerPool.postMessage({type:`transcode`,buffer:e,taskConfig:i},[e])).then(e=>this._createTextureFrom(e.data,n));return Yd.set(e,{promise:a}),a}dispose(){this.workerPool.dispose(),this.workerSourceURL&&URL.revokeObjectURL(this.workerSourceURL),Xd--}};Qd.BasisFormat={ETC1S:0,UASTC:1,UASTC_HDR:2},Qd.TranscoderFormat={ETC1:0,ETC2:1,BC1:2,BC3:3,BC4:4,BC5:5,BC7_M6_OPAQUE_ONLY:6,BC7_M5:7,PVRTC1_4_RGB:8,PVRTC1_4_RGBA:9,ASTC_4x4:10,ATC_RGB:11,ATC_RGBA_INTERPOLATED_ALPHA:12,RGBA32:13,RGB565:14,BGR565:15,RGBA4444:16,BC6H:22,RGB_HALF:24,RGBA_HALF:25},Qd.EngineFormat={RGBAFormat:T,RGBA_ASTC_4x4_Format:me,RGB_BPTC_UNSIGNED_Format:Ae,RGBA_BPTC_Format:Oe,RGBA_ETC2_EAC_Format:le,RGBA_PVRTC_4BPPV1_Format:oe,RGBA_S3TC_DXT5_Format:M,RGB_ETC1_Format:N,RGB_ETC2_Format:ce,RGB_PVRTC_4BPPV1_Format:ie,RGBA_S3TC_DXT1_Format:j},Qd.EngineType={UnsignedByteType:u,HalfFloatType:_,FloatType:g},Qd.BasisWorker=function(){let e,t,n,r=_EngineFormat,i=_EngineType,a=_TranscoderFormat,o=_BasisFormat;self.addEventListener(`message`,function(n){let r=n.data;switch(r.type){case`init`:e=r.config,s(r.transcoderBinary);break;case`transcode`:t.then(()=>{try{let{faces:e,buffers:t,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}=c(r.buffer);self.postMessage({type:`transcode`,id:r.id,data:{faces:e,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}},t)}catch(e){console.error(e),self.postMessage({type:`error`,id:r.id,error:e.message})}});break}});function s(e){t=new Promise(t=>{n={wasmBinary:e,onRuntimeInitialized:t},BASIS(n)}).then(()=>{n.initializeBasis(),n.KTX2File===void 0&&console.warn(`THREE.KTX2Loader: Please update Basis Universal transcoder.`)})}function c(e){let t=new n.KTX2File(new Uint8Array(e));function r(){t.close(),t.delete()}if(!t.isValid())throw r(),Error(`THREE.KTX2Loader:	Invalid or unsupported .ktx2 file`);let a;if(t.isUASTC())a=o.UASTC;else if(t.isETC1S())a=o.ETC1S;else if(t.isHDR())a=o.UASTC_HDR;else throw Error(`THREE.KTX2Loader: Unknown Basis encoding`);let s=t.getWidth(),c=t.getHeight(),l=t.getLayers()||1,u=t.getLevels(),f=t.getFaces(),m=t.getHasAlpha(),h=t.getDFDFlags(),{transcoderFormat:g,engineFormat:_,engineType:v}=d(a,s,c,m);if(!s||!c||!u)throw r(),Error(`THREE.KTX2Loader:	Invalid texture`);if(!t.startTranscoding())throw r(),Error(`THREE.KTX2Loader: .startTranscoding failed`);let y=[],b=[];for(let e=0;e<f;e++){let n=[];for(let a=0;a<u;a++){let o=[],s,c;for(let n=0;n<l;n++){let l=t.getImageLevelInfo(a,n,e);e===0&&a===0&&n===0&&(l.origWidth%4!=0||l.origHeight%4!=0)&&console.warn(`THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions.`),u>1?(s=l.origWidth,c=l.origHeight):(s=l.width,c=l.height);let d=new Uint8Array(t.getImageTranscodedSizeInBytes(a,n,0,g)),f=t.transcodeImage(d,a,n,e,g,0,-1,-1);if(v===i.HalfFloatType&&(d=new Uint16Array(d.buffer,d.byteOffset,d.byteLength/Uint16Array.BYTES_PER_ELEMENT)),!f)throw r(),Error(`THREE.KTX2Loader: .transcodeImage failed.`);o.push(d)}let d=p(o);n.push({data:d,width:s,height:c}),b.push(d.buffer)}y.push({mipmaps:n,width:s,height:c,format:_,type:v})}return r(),{faces:y,buffers:b,width:s,height:c,hasAlpha:m,dfdFlags:h,format:_,type:v}}let l=[{if:`astcSupported`,basisFormat:[o.UASTC],transcoderFormat:[a.ASTC_4x4,a.ASTC_4x4],engineFormat:[r.RGBA_ASTC_4x4_Format,r.RGBA_ASTC_4x4_Format],engineType:[i.UnsignedByteType],priorityETC1S:1/0,priorityUASTC:1,needsPowerOfTwo:!1},{if:`bptcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC7_M5,a.BC7_M5],engineFormat:[r.RGBA_BPTC_Format,r.RGBA_BPTC_Format],engineType:[i.UnsignedByteType],priorityETC1S:3,priorityUASTC:2,needsPowerOfTwo:!1},{if:`dxtSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC1,a.BC3],engineFormat:[r.RGBA_S3TC_DXT1_Format,r.RGBA_S3TC_DXT5_Format],engineType:[i.UnsignedByteType],priorityETC1S:4,priorityUASTC:5,needsPowerOfTwo:!1},{if:`etc2Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1,a.ETC2],engineFormat:[r.RGB_ETC2_Format,r.RGBA_ETC2_EAC_Format],engineType:[i.UnsignedByteType],priorityETC1S:1,priorityUASTC:3,needsPowerOfTwo:!1},{if:`etc1Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1],engineFormat:[r.RGB_ETC1_Format],engineType:[i.UnsignedByteType],priorityETC1S:2,priorityUASTC:4,needsPowerOfTwo:!1},{if:`pvrtcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.PVRTC1_4_RGB,a.PVRTC1_4_RGBA],engineFormat:[r.RGB_PVRTC_4BPPV1_Format,r.RGBA_PVRTC_4BPPV1_Format],engineType:[i.UnsignedByteType],priorityETC1S:5,priorityUASTC:6,needsPowerOfTwo:!0},{if:`bptcSupported`,basisFormat:[o.UASTC_HDR],transcoderFormat:[a.BC6H],engineFormat:[r.RGB_BPTC_UNSIGNED_Format],engineType:[i.HalfFloatType],priorityHDR:1,needsPowerOfTwo:!1},{basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.RGBA32,a.RGBA32],engineFormat:[r.RGBAFormat,r.RGBAFormat],engineType:[i.UnsignedByteType,i.UnsignedByteType],priorityETC1S:100,priorityUASTC:100,needsPowerOfTwo:!1},{basisFormat:[o.UASTC_HDR],transcoderFormat:[a.RGBA_HALF],engineFormat:[r.RGBAFormat],engineType:[i.HalfFloatType],priorityHDR:100,needsPowerOfTwo:!1}],u={[o.ETC1S]:l.filter(e=>e.basisFormat.includes(o.ETC1S)).sort((e,t)=>e.priorityETC1S-t.priorityETC1S),[o.UASTC]:l.filter(e=>e.basisFormat.includes(o.UASTC)).sort((e,t)=>e.priorityUASTC-t.priorityUASTC),[o.UASTC_HDR]:l.filter(e=>e.basisFormat.includes(o.UASTC_HDR)).sort((e,t)=>e.priorityHDR-t.priorityHDR)};function d(t,n,r,i){let a=u[t];for(let o=0;o<a.length;o++){let s=a[o];if(!(s.if&&!e[s.if])&&s.basisFormat.includes(t)&&!(i&&s.transcoderFormat.length<2)&&!(s.needsPowerOfTwo&&!(f(n)&&f(r))))return{transcoderFormat:s.transcoderFormat[+!!i],engineFormat:s.engineFormat[+!!i],engineType:s.engineType[0]}}throw Error(`THREE.KTX2Loader: Failed to identify transcoding target.`)}function f(e){return e<=2?!0:(e&e-1)==0&&e!==0}function p(e){if(e.length===1)return e[0];let t=0;for(let n=0;n<e.length;n++){let r=e[n];t+=r.byteLength}let n=new Uint8Array(t),r=0;for(let t=0;t<e.length;t++){let i=e[t];n.set(i,r),r+=i.byteLength}return n}};var $d=new Set([T,w,k,O]),ef={109:T,103:k,100:O,97:T,83:k,76:O,91:T,43:T,37:T,22:k,16:k,15:O,9:O,123:w,122:w,152:le,148:ce,153:ue,154:de,155:fe,156:pe,[Fd]:me,158:me,157:me,[Id]:ve,166:ve,165:ve,134:j,133:j,132:A,131:A,138:M,137:M,140:P,139:je,142:F,141:Me,146:Oe,145:Oe,[Pd]:oe,[Md]:oe,[Nd]:se,[jd]:se},tf={109:g,103:g,100:g,97:_,83:_,76:_,91:p,43:u,37:u,22:u,16:u,15:u,9:u,123:x,122:S,152:u,148:u,153:u,154:u,155:u,156:u,[Fd]:_,158:u,157:u,[Id]:_,166:u,165:u,134:u,133:u,132:u,131:u,138:u,137:u,140:u,139:u,142:u,141:u,146:u,145:u,[Pd]:u,[Md]:u,[Nd]:u,[jd]:u};async function nf(e){let{vkFormat:t}=e;if(ef[t]===void 0)throw Error(`THREE.KTX2Loader: Unsupported vkFormat: `+t);tf[t]===void 0&&console.warn(`THREE.KTX2Loader: Missing ".type" for vkFormat: `+t);let n;e.supercompressionScheme===2&&(Zd||=new Promise(async e=>{let t=new Gd;await t.init(),e(t)}),n=await Zd);let r=[];for(let i=0;i<e.levels.length;i++){let a=Math.max(1,e.pixelWidth>>i),o=Math.max(1,e.pixelHeight>>i),s=e.pixelDepth?Math.max(1,e.pixelDepth>>i):0,c=e.levels[i],l;if(e.supercompressionScheme===0)l=c.levelData;else if(e.supercompressionScheme===2)l=n.decode(c.levelData,c.uncompressedByteLength);else throw Error(`THREE.KTX2Loader: Unsupported supercompressionScheme.`);let u;u=tf[t]===1015?new Float32Array(l.buffer,l.byteOffset,l.byteLength/Float32Array.BYTES_PER_ELEMENT):tf[t]===1016||tf[t]===1012?new Uint16Array(l.buffer,l.byteOffset,l.byteLength/Uint16Array.BYTES_PER_ELEMENT):tf[t]===35902||tf[t]===35899?new Uint32Array(l.buffer,l.byteOffset,l.byteLength/Uint32Array.BYTES_PER_ELEMENT):l,r.push({data:u,width:a,height:o,depth:s})}let o=e.levelCount===0||r.length>1,c;if($d.has(ef[t]))c=e.pixelDepth===0?new mi(r[0].data,e.pixelWidth,e.pixelHeight):new Xt(r[0].data,e.pixelWidth,e.pixelHeight,e.pixelDepth),c.minFilter=o?a:i,c.magFilter=i,c.generateMipmaps=e.levelCount===0;else{if(e.pixelDepth>0)throw Error(`THREE.KTX2Loader: Unsupported pixelDepth.`
gvclp:Teavp9qgop;6ep;Negvaicwp:RecKp:SegraipxFbbbFbbbFbbbFbbbgwp9ogDp:Uep;6ep;Mepxbbn0bbn0bbn0bbn0gqp;Kecwp:RepxbFbbbFbbbFbbbFbbp9oavaDarp:Xeaiczp:RecKp:Segip:Uep;6ep;Meaqp;Keawp9op9qavaDaraip:Uep:Xep;6ep;Meaqp;Keczp:RepxbbFbbbFbbbFbbbFbp9op9qavaoalcep:Rep9oalpxebbbebbbebbbebbbp9op9qp;6ep;Meaqp;KecKp:Rep9qpkbbabczfhbadclfgdae6mbxdkkaeTmbcbhdinabczfgkpxbFu9hbFu9hbFu9hbFu9habpbbbglakpbbbgrpmlvorxmPsCXQL358E8Fgvczp:TegqavcHp:Tep9qgicdp:Teaip9qgiclp:Teaip9qgicwp:Teaip9qgop;6ep;NegialarpmbediwDqkzHOAKY8AEgDpxFFbbFFbbFFbbFFbbglp9ograDczp:Segwp:Ueavczp:Reczp:SegDp:Xep;6ep;Mepxbbn0bbn0bbn0bbn0gvp;Kealp9oaiarawaDp:Uep:Xep;6ep;Meavp;Keczp:Rep9qgwaiaoaqcep:Rep9oaqpxebbbebbbebbbebbbp9op9qp;6ep;Meavp;Keczp:ReaiaDarp:Uep;6ep;Meavp;Kealp9op9qgipmwDKYqk8AExm35Ps8E8FpkbbabawaipmbezHdiOAlvCXorQLpkbbabcafhbadclfgdae6mbkkk9teiucbcbydj:G:cjbgeabcifc98GfgbBdj:G:cjbdndnabZbcztgd9nmbcuhiabad9RcFFifcz4nbcuSmekaehikaikkxebcj:Gdklz:zbb`,n=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,3,2,0,0,5,3,1,0,1,12,1,0,10,22,2,12,0,65,0,65,0,65,0,252,10,0,0,11,7,0,65,0,253,15,26,11]),r=new Uint8Array([32,0,65,2,1,106,34,33,3,128,11,4,13,64,6,253,10,7,15,116,127,5,8,12,40,16,19,54,20,9,27,255,113,17,42,67,24,23,146,148,18,14,22,45,70,69,56,114,101,21,25,63,75,136,108,28,118,29,73,115]);if(typeof WebAssembly!=`object`)return{supported:!1};var i=WebAssembly.validate(n)?s(t):s(e),a,o=WebAssembly.instantiate(i,{}).then(function(e){a=e.instance,a.exports.__wasm_call_ctors()});function s(e){for(var t=new Uint8Array(e.length),n=0;n<e.length;++n){var i=e.charCodeAt(n);t[n]=i>96?i-97:i>64?i-39:i+4}for(var a=0,n=0;n<e.length;++n)t[a++]=t[n]<60?r[t[n]]:(t[n]-60)*64+t[++n];return t.buffer.slice(0,a)}function c(e,t,n,r,i,a,o){var s=e.exports.sbrk,c=r+3&-4,l=s(c*i),u=s(a.length),d=new Uint8Array(e.exports.memory.buffer);d.set(a,u);var f=t(l,r,i,u,a.length);if(f==0&&o&&o(l,c,i),n.set(d.subarray(l,l+r*i)),s(l-s(0)),f!=0)throw Error(`Malformed buffer data: `+f)}var l={NONE:``,OCTAHEDRAL:`meshopt_decodeFilterOct`,QUATERNION:`meshopt_decodeFilterQuat`,EXPONENTIAL:`meshopt_decodeFilterExp`,COLOR:`meshopt_decodeFilterColor`},u={ATTRIBUTES:`meshopt_decodeVertexBuffer`,TRIANGLES:`meshopt_decodeIndexBuffer`,INDICES:`meshopt_decodeIndexSequence`},d=[],f=0;function p(e){var t={object:new Worker(e),pending:0,requests:{}};return t.object.onmessage=function(e){var n=e.data;t.pending-=n.count,t.requests[n.id][n.action](n.value),delete t.requests[n.id]},t}function m(e){for(var t=`self.ready = WebAssembly.instantiate(new Uint8Array([`+new Uint8Array(i)+`]), {}).then(function(result) { result.instance.exports.__wasm_call_ctors(); return result.instance; });self.onmessage = `+g.name+`;`+c.toString()+g.toString(),n=new Blob([t],{type:`text/javascript`}),r=URL.createObjectURL(n),a=d.length;a<e;++a)d[a]=p(r);for(var a=e;a<d.length;++a)d[a].object.postMessage({});d.length=e,URL.revokeObjectURL(r)}function h(e,t,n,r,i){for(var a=d[0],o=1;o<d.length;++o)d[o].pending<a.pending&&(a=d[o]);return new Promise(function(o,s){var c=new Uint8Array(n),l=++f;a.pending+=e,a.requests[l]={resolve:o,reject:s},a.object.postMessage({id:l,count:e,size:t,source:c,mode:r,filter:i},[c.buffer])})}function g(e){var t=e.data;self.ready.then(function(e){if(!t.id)return self.close();try{var n=new Uint8Array(t.count*t.size);c(e,e.exports[t.mode],n,t.count,t.size,t.source,e.exports[t.filter]),self.postMessage({id:t.id,count:t.count,action:`resolve`,value:n},[n.buffer])}catch(e){self.postMessage({id:t.id,count:t.count,action:`reject`,value:e})}})}return{ready:o,supported:!0,useWorkers:function(e){m(e)},decodeVertexBuffer:function(e,t,n,r,i){c(a,a.exports.meshopt_decodeVertexBuffer,e,t,n,r,a.exports[l[i]])},decodeIndexBuffer:function(e,t,n,r){c(a,a.exports.meshopt_decodeIndexBuffer,e,t,n,r)},decodeIndexSequence:function(e,t,n,r){c(a,a.exports.meshopt_decodeIndexSequence,e,t,n,r)},decodeGltfBuffer:function(e,t,n,r,i,o){c(a,a.exports[u[i]],e,t,n,r,a.exports[l[o]])},decodeGltfBufferAsync:function(e,t,n,r,i){return d.length>0?h(e,t,n,u[r],l[i]):o.then(function(){var o=new Uint8Array(e*t);return c(a,a.exports[u[r]],o,e,t,n,a.exports[l[i]]),o})}}})();window.isAppTauriRunning&&(document.querySelector(`.info-nomobilecontrol`)?.remove(),document.querySelector(`.help-overlay`)?.remove());var of=23.3,sf=4/3,cf=`loading`,lf=0,uf=0,df=null,ff=null,pf=null,mf=45,hf=0,gf=0,_f=document.querySelector(`#game-canvas`);function vf(){let e=window.innerWidth,t=window.innerHeight,n=e,r=e/sf;return r>t&&(r=t,n=r*sf),{width:n,height:r}}var yf=vf(),bf=new Pn;bf.fog=new Nn(855306,.09);var xf=new ho(60,sf,.1,1e3),Sf=new Tn;Sf.add(xf),bf.add(Sf);var Q={position:new W(0,1.6,0),height:1.6,radius:.6,walkSpeed:2.28,runSpeed:6.2,velocity:new W,acceleration:10,friction:6};Sf.position.copy(Q.position);var Cf=new Du({canvas:_f,antialias:!1});Cf.setSize(yf.width,yf.height),Cf.setPixelRatio(1),Cf.shadowMap.enabled=!0,Cf.shadowMap.type=1,Cf.toneMapping=4,Cf.toneMappingExposure=2.43;var wf=new Qd().setTranscoderPath(`/basis/`).detectSupport(Cf),Tf=new Jt(yf.width,yf.height),Ef=new Co(16777215,1.4);bf.add(Ef);var Df=new _o(16777215,8,35,Math.PI/3.8,.6,1);Df.castShadow=!0,Df.shadow.mapSize.width=256,Df.shadow.mapSize.height=256,Df.shadow.camera.near=.5,Df.shadow.camera.far=35,Df.shadow.bias=-.004,bf.add(Df),bf.add(Df.target);var Of=new So(16777215,.5);Of.position.set(0,5,0),Of.castShadow=!0,Of.shadow.mapSize.width=256,Of.shadow.bias=-.004,bf.add(Of);var kf=new Vo;xf.add(kf);var Af=new Ho(kf),jf=new Ho(kf),Mf=new ko,Nf=null,Pf=null,Ff=null,If=null,Lf=[],Rf=10,zf=0,Bf=new Map,Vf=!1,Hf=null,Uf=null,Wf=null,Gf=null,Kf=60+Math.random()*60,qf=`idle`,Jf=0,Yf=new W,Xf=30+Math.random()*45,Zf=!1,Qf=null,$f=0,ep=document.createElement(`canvas`);ep.width=512,ep.height=512;var $=ep.getContext(`2d`),tp=new oa(ep);tp.minFilter=s;var np=0;function rp(e){if($.clearRect(0,0,ep.width,ep.height),$.shadowColor=`rgba(0, 0, 0, 0.85)`,$.shadowBlur=4,$.shadowOffsetX=2,$.shadowOffsetY=2,$.font=`bold 24px 'JetBrains Mono', monospace`,$.textAlign=`center`,$.fillStyle=`#ffffff`,cf===`loading`)$.font=`bold 28px 'JetBrains Mono', monospace`,$.fillText(`LOADING...`,256,210),$.font=`16px 'JetBrains Mono', monospace`,$.fillStyle=`#88887c`,$.fillText(`${np}%`,256,240),$.shadowColor=`transparent`,$.strokeStyle=`#444438`,$.lineWidth=2,$.strokeRect(136,260,240,8),$.fillStyle=`#ffffff`,$.fillRect(136,260,np/100*240,8);else if(cf===`voice-setup`){$.fillText(`MICROPHONE CONFIGURATION`,256,110),$.font=`13px 'JetBrains Mono', monospace`,$.fillStyle=`#88887c`,$.fillText(`Adjust threshold limit to balance voice load`,256,140),$.shadowColor=`transparent`;for(let e=0;e<34;e++){let t=e/34*100,n=120+e*8;hf>=t?t>mf?$.fillStyle=`#ff3333`:$.fillStyle=`#ffffff`:$.fillStyle=`#22221b`,$.fillRect(n,180,5,22)}let t=120+mf/100*269;if($.strokeStyle=`#ffaa00`,$.lineWidth=2,$.beginPath(),$.moveTo(t,172),$.lineTo(t,210),$.stroke(),$.shadowColor=`rgba(0, 0, 0, 0.85)`,$.font=`bold 15px 'JetBrains Mono', monospace`,$.fillStyle=`#ffffff`,$.fillText(`LIMIT LOAD THRESHOLD: ${mf}%`,256,245),$.font=`13px 'JetBrains Mono', monospace`,hf>mf){let e=Math.floor(Math.random()*200)+200;$.fillStyle=`#ff3333`,$.fillText(`CURRENT LOAD: ${e}ms - CRITICAL OVERFLOW!`,256,275)}else $.fillStyle=`#33ff33`,$.fillText(`CURRENT LOAD: ${Math.max(12,Math.round(hf*.4))}ms - NOMINAL`,256,275);$.font=`12px 'JetBrains Mono', monospace`,$.fillStyle=`#a8a89c`,$.fillText(`Press [-] to Decrease | [+] to Increase`,256,310);let n=Math.sin(e*.006)>0;$.font=`bold 15px 'JetBrains Mono', monospace`,$.fillStyle=n?`#ffffff`:`#444438`,$.fillText(`[ PRESS ENTER TO CONNECT CAMERA ]`,256,370)}else if(cf===`paused`){$.font=`bold 36px 'JetBrains Mono', monospace`,$.fillStyle=`#ffaa00`,$.fillText(`PAUSED`,256,180),$.font=`16px 'JetBrains Mono', monospace`,$.fillStyle=`#88887c`,$.fillText(`SURVIVED TIME: ${Math.round(lf)}s`,256,220),$.fillText(`GAME IS TEMPORARILY PAUSED`,256,245),$.font=`bold 22px 'JetBrains Mono', monospace`,$.fillStyle=`#ffffff`,$.fillText(`[Screen!] Resume`,256,290),$.fillText(`[M] ${Vf?`Unmute`:`Mute`} Audio`,256,320);let t=Math.sin(e*.006)>0;$.font=`bold 15px 'JetBrains Mono', monospace`,$.fillStyle=t?`#ffffff`:`#444438`,$.fillText(`Click screen to resume`,256,380)}else if(cf===`gameover`){$.font=`bold 36px 'JetBrains Mono', monospace`,$.fillStyle=`#ff3333`,$.fillText(`Disconnecting`,256,180),$.font=`16px 'JetBrains Mono', monospace`,$.fillStyle=`#88887c`,$.fillText(`CRITICAL SIGNAL LOAD OVERFLOW (200ms-400ms)`,256,220),$.font=`bold 20px 'JetBrains Mono', monospace`,$.fillStyle=`#ffffff`,$.fillText(`SURVIVED TIME: ${uf}s`,256,270);let t=Math.sin(e*.006)>0;$.font=`bold 15px 'JetBrains Mono', monospace`,$.fillStyle=t?`#ffffff`:`#333333`,$.fillText(`Please hit ENTER to restart game`,256,360)}tp.needsUpdate=!0}var ip=!1;document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===_f?(ip=!0,cf===`paused`&&(cf=`playing`,Af.setVolume(Vf?0:.4),jf.setVolume(Vf?0:.5))):(ip=!1,up=0,dp=0,cf===`playing`&&(cf=`paused`,Af.setVolume(.08),jf.setVolume(.08)))}),_f.addEventListener(`click`,()=>{(cf===`playing`||cf===`paused`)&&_f.requestPointerLock()});var ap=new kt,op=0,sp=0,cp=0,lp=0,up=0,dp=0;document.addEventListener(`mousemove`,e=>{!ip||cf!==`playing`||(op-=e.movementX*.002,sp-=e.movementY*.002,sp=Math.max(-Math.PI/2.2,Math.min(Math.PI/2.2,sp)),up+=Math.abs(e.movementX)*.2,dp+=Math.abs(e.movementY)*.2)});var fp=!0;_f.addEventListener(`mousedown`,e=>{if(cf===`playing`&&ip&&e.button===0){fp=!fp,Df.visible=fp;let e=new Ho(kf);e.setBuffer(fp?Ff:If),e.setVolume(.7),e.play()}});var pp=60,mp=60;_f.addEventListener(`wheel`,e=>{cf===`playing`&&(e.preventDefault(),mp+=e.deltaY*.05,mp=Math.max(12,Math.min(60,mp)))},{passive:!1});var hp={w:!1,a:!1,s:!1,d:!1,q:!1,e:!1,shift:!1};window.addEventListener(`keydown`,e=>{if(cf===`voice-setup`){(e.key===`-`||e.key===`_`)&&(mf=Math.max(10,mf-5)),(e.key===`+`||e.key===`=`)&&(mf=Math.min(95,mf+5)),e.key===`Enter`&&(cf=`playing`,Ap());return}if(cf===`gameover`&&e.key===`Enter`){zp();return}if(e.key.toLowerCase()===`m`){Vf=!Vf;let e=Vf?0:.5;Af.setVolume(Vf?0:.4),jf.setVolume(e)}let t=e.key.toLowerCase();t===`shift`?hp.shift=!0:t in hp&&(hp[t]=!0)}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();t===`shift`?hp.shift=!1:t in hp&&(hp[t]=!1)});function gp(){navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(e=>{df=new(window.AudioContext||window.webkitAudioContext);let t=df.createMediaStreamSource(e);ff=df.createAnalyser(),ff.fftSize=256,pf=new Uint8Array(ff.frequencyBinCount),t.connect(ff),cf=`voice-setup`}).catch(e=>{alert(`ALERT! Game ini wajib mengaktifkan izin Microphone untuk bermain!`),console.error(`Izin mic ditolak:`,e)})}function _p(e){if(!ff)return;ff.getByteFrequencyData(pf);let t=0;for(let e=0;e<pf.length;e++)t+=pf[e];let n=t/pf.length;hf=Math.min(Math.round(n/128*100),100),cf===`playing`&&(hf>mf?(gf+=e*1e3,gf>=270&&Rp()):gf=Ot.lerp(gf,0,.1))}var vp=20,yp=new Map,bp=[],xp=[],Sp=new ju;Sp.setKTX2Loader(wf),Sp.setMeshoptDecoder(af);var Cp=new ss,wp={1:null,2:null,3:null,4:null},Tp=new Map,Ep=6,Dp=0;function Op(){let e=0;Tp.forEach(t=>{e+=t}),Bf.forEach(t=>{e+=t}),np=Math.min(Math.round(e/16),100),Dp>=Ep&&zf>=Rf&&cf===`loading`&&gp()}function kp(){[{id:1,url:`/models/room1.glb`},{id:2,url:`/models/room2.glb`},{id:3,url:`/models/room3.glb`},{id:4,url:`/models/room4.glb`},{id:`solo`,url:`/models/scp-solo02.glb`},{id:`falling`,url:`/models/scp-opgmbg01.glb`}].forEach(e=>{Tp.set(e.id,0),Sp.load(e.url,t=>{typeof e.id==`number`?wp[e.id]=t.scene:e.id===`solo`?(Hf=t.scene,Hf.visible=!1,bf.add(Hf)):e.id===`falling`&&(Uf=t.scene),Dp++,Tp.set(e.id,100),Op()},t=>{t.total>0&&(Tp.set(e.id,t.loaded/t.total*100),Op())},e=>console.error(`Load gagal:`,e))}),[{name:`noise`,url:`/bg/bg-noise-backroom.mp3`},{name:`song`,url:`/bg/bg-song-daise.mp3`},{name:`fsLeft`,url:`/sfx/footstep-left.mp3`},{name:`fsRight`,url:`/sfx/footstep-right.mp3`},{name:`flashOn`,url:`/sfx/flashlight-on.mp3`},{name:`flashOff`,url:`/sfx/flashlight-off.mp3`},{name:`amb1`,url:`/ambiences/banyak-negara-yang-panik-indonesia-masih-ok.mp3`},{name:`amb2`,url:`/ambiences/desa-ga-pakai-dolar.mp3`},{name:`jumpscare`,url:`/sfx/jumpscare-wokaget.mp3`},{name:`metal`,url:`/sfx/hit-metal-falling.mp3`}].forEach((e,t)=>{Bf.set(t,0),Mf.load(e.url,n=>{t===0?Af.setBuffer(n):t===1?jf.setBuffer(n):e.name===`fsLeft`?Nf=n:e.name===`fsRight`?Pf=n:e.name===`flashOn`?Ff=n:e.name===`flashOff`?If=n:e.name===`amb1`?Lf[0]=n:e.name===`amb2`?Lf[1]=n:e.name===`jumpscare`?Wf=n:e.name===`metal`&&(Gf=n),zf++,Bf.set(t,100),Op()},e=>{e.total>0&&(Bf.set(t,e.loaded/e.total*100),Op())})})}function Ap(){setTimeout(()=>{_f.requestPointerLock()},200),lf=0,gf=0,Af.setLoop(!0),Af.setVolume(.4),Af.play(),jf.setLoop(!0),jf.setVolume(.5),jf.play(),jp(0,0),jp(1,0),jp(-1,0),jp(0,1),jp(0,-1)}function jp(e,t){let n=`${e},${t}`;if(yp.has(n))return;let r=new Tn;r.position.set(e*vp,0,t*vp),bf.add(r),yp.set(n,{group:r,loaded:!0});let i=Math.sin(e*12.9898+t*78.233)*43758.5453123,a=i-Math.floor(i),o=wp[Math.floor(a*4)+1];if(!o)return;let s=o.clone();r.add(s),s.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material&&(e.material.roughness=Math.max(e.material.roughness,.5)),e.name.toLowerCase().includes(`floor`)||e.name.toLowerCase().includes(`lantai`)?(e.material&&(e.material.roughness=.05,e.material.metalness=.1),xp.push(e)):bp.push(e))}),e===0&&t===0&&Lp()}function Mp(){if(cf!==`playing`)return;let e=Math.round(Q.position.x/vp),t=Math.round(Q.position.z/vp);for(let n=-1;n<=1;n++)for(let r=-1;r<=1;r++)Math.abs(n)+Math.abs(r)<=1&&jp(e+n,t+r);yp.forEach((n,r)=>{let[i,a]=r.split(`,`).map(Number),o=Math.abs(i-e)+Math.abs(a-t);o>=3?(bf.remove(n.group),n.group.traverse(e=>{if(e.isMesh){let t=bp.indexOf(e);t>-1&&bp.splice(t,1);let n=xp.indexOf(e);n>-1&&xp.splice(n,1),e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}}),yp.delete(r)):o===2?n.group.visible=!1:n.group.visible=!0})}kp();var Np=new ba({uniforms:{tDiffuse:{value:null},tHUD:{value:tp},uTime:{value:0},uBlurIntensity:{value:0},uScreenState:{value:0}},vertexShader:`
  ...
  `}),Pp=new Pn,Fp=new bo(-1,1,1,-1,0,1),Ip=new ei(new da(2,2),Np);Pp.add(Ip);function Lp(){Np.uniforms.uScreenState.value!==1&&setTimeout(()=>{Np.uniforms.uScreenState.value=1,up=4,dp=4},400)}function Rp(){cf=`gameover`,uf=Math.round(lf),Af.stop(),jf.stop(),document.exitPointerLock(),xf.rotation.set(Math.PI/2.3,0,Math.PI/4),Sf.position.y=Q.position.y-1.45,setTimeout(()=>{Np.uniforms.uScreenState.value=0},350)}function zp(){yp.forEach(e=>bf.remove(e.group)),yp.clear(),bp.length=0,xp.length=0,Q.position.set(0,1.6,0),Q.velocity.set(0,0,0),Sf.position.copy(Q.position),xf.rotation.set(0,0,0),op=0,sp=0,cp=0,lp=0,Sf.rotation.set(0,0,0),Qp=0,$p=0,em=0,tm=0,nm=0,rm=1,fm=0,pm=30+Math.random()*60,fp=!0,Df.visible=!0,pp=60,mp=60,xf.fov=60,xf.updateProjectionMatrix(),Np.uniforms.uScreenState.value=0,cf=`voice-setup`}function Bp(e){if(!ip||cf!==`playing`)return;let t=hp.shift?Q.runSpeed:Q.walkSpeed,n=new W(0,0,-1).applyQuaternion(Sf.quaternion),r=new W(1,0,0).applyQuaternion(Sf.quaternion);n.y=0,n.normalize(),r.y=0,r.normalize();let i=0,a=0;hp.w&&(i+=n.x,a+=n.z),hp.s&&(i-=n.x,a-=n.z),hp.d&&(i+=r.x,a+=r.z),hp.a&&(i-=r.x,a-=r.z);let o=Math.sqrt(i*i+a*a);if(o>.001){i/=o,a/=o,Q.velocity.x+=i*Q.acceleration*e,Q.velocity.z+=a*Q.acceleration*e;let n=Math.sqrt(Q.velocity.x**2+Q.velocity.z**2);n>t&&(Q.velocity.x*=t/n,Q.velocity.z*=t/n),up+=hp.shift?.35:.18}else{let t=Math.sqrt(Q.velocity.x**2+Q.velocity.z**2);if(t>0){let n=Q.friction*e;if(n>=t)Q.velocity.x=0,Q.velocity.z=0;else{let e=(t-n)/t;Q.velocity.x*=e,Q.velocity.z*=e}}}let s=Q.position.clone();s.x+=Q.velocity.x*e,s.z+=Q.velocity.z*e;let c=!0,l=!0;if(Math.sqrt(Q.velocity.x**2+Q.velocity.z**2)>.001&&bp.length>0){let e=new W(Q.position.x,Q.position.y-.5,Q.position.z);Cp.set(e,new W(Q.velocity.x,0,0).normalize());let t=Cp.intersectObjects(bp);t.length>0&&t[0].distance<Q.radius&&(c=!1),Cp.set(e,new W(0,0,Q.velocity.z).normalize());let n=Cp.intersectObjects(bp);n.length>0&&n[0].distance<Q.radius&&(l=!1)}c?Q.position.x=s.x:Q.velocity.x=0,l?Q.position.z=s.z:Q.velocity.z=0}var Vp=0,Hp=!0;function Up(){let e=Hp?Nf:Pf;if(!e)return;let t=new Ho(kf);t.setBuffer(e),t.setVolume(hp.shift?.65:.45),t.play(),Hp=!Hp}function Wp(e){let t=hp.w||hp.a||hp.s||hp.d;if(!ip||!t||cf!==`playing`){Vp=0;return}let n=hp.shift?.22:.38;Vp+=e,Vp>=n&&(Vp=0,Up())}var Gp=0,Kp=0,qp=0,Jp=0,Yp=0,Xp=0,Zp=0,Qp=0,$p=0,em=0,tm=0,nm=0,rm=1,im=0,am=.38,om=0,sm=0,cm=1,lm=0;function um(e){if(cf!==`playing`)return;let t=(hp.w||hp.a||hp.s||hp.d)&&ip,n=hp.shift&&t;om=Ot.lerp(om,+!!t,.08),sm=Ot.lerp(sm,+!!n,.06);let r=n?.22:.38;am=Ot.lerp(am,r,.1),im+=e;let i=Math.PI/am;Gp+=e*i*om;let a=Gp,o=im*1.5,s=(Math.sin(im*15.1)*.4+Math.sin(im*27.3)*.3+Math.sin(im*41.7)*.2)*.002,c=(Math.sin(im*17.2)*.4+Math.sin(im*23.1)*.3+Math.sin(im*37.1)*.2)*.002,l=(Math.sin(o*.7)*.5+Math.sin(o*1.3)*.3)*.03,u=(Math.cos(o*.6)*.5+Math.sin(o*1.1)*.3)*.03,d=(Math.sin(o*.5)*.5+Math.cos(o*.9)*.3)*.02,f=(.04+sm*.05)*om,p=(.08+sm*.12)*om,m=(.02+sm*.08)*om,h=(.03+sm*.04)*om,g=Math.cos(a*.5)*f,_=Math.abs(Math.sin(a))**2.2*p,v=Math.sin(a*.5)*m,y=Math.cos(a)*h,b=op-cp;b=Math.atan2(Math.sin(b),Math.cos(b));let x=Math.PI/180*14,S=Math.max(-x,Math.min(x,-b*3.5));lm=Ot.lerp(lm,S,.1);let C=l+g+s,w=u+_+c;if(sm>.1){let e=Math.sin(a*2)*Math.cos(a*.5);w+=e*.08*sm,C+=Math.cos(a*2.5)*.05*sm}let T=d+v+lm+s*2.5,E=y+c*2.5;Kp=Ot.lerp(Kp,C,.12),qp=Ot.lerp(qp,w,.12),Jp=Ot.lerp(Jp,T,.12),Yp=Ot.lerp(Yp,E,.12);let D=Math.abs(Math.sin(a))**8*(.02+sm*.03)*om;xf.rotation.y=Ot.lerp(xf.rotation.y,Math.sin(a*.5)*.015*om+l*.5,.05),xf.rotation.x=Ot.lerp(xf.rotation.x,lp+Yp+D,.25);let O=0,ee=0;if(ip){if(hp.q?(em=-1.1,tm=.52,nm=.2,rm=1):hp.e&&(em=1.1,tm=-.52,nm=.2,rm=1),hp.q||hp.e)O=em,ee=tm;else if(em!==0||tm!==0)if(nm>0)nm-=e,O=em,ee=tm;else{rm=Math.max(0,rm-e*3);let t=1-(1-(1-rm))**3;O=Ot.lerp(0,em,1-t),ee=Ot.lerp(0,tm,1-t),rm<=0&&(em=0,tm=0,rm=1)}}Xp=Ot.lerp(Xp,O,.1),Zp=Ot.lerp(Zp,ee,.1);let k=new W(Kp+Xp,qp-.05,0).applyQuaternion(Sf.quaternion),te=Q.position.clone(),ne=k.clone().normalize(),A=k.length(),j=1;if(A>.01&&bp.length>0){Cp.set(te,ne);let e=Cp.intersectObjects(bp);e.length>0&&e[0].distance<A+.25&&(j=Math.max(0,(e[0].distance-.25)/A))}cm=Ot.lerp(cm,j,.15),k.multiplyScalar(cm),Sf.position.copy(Q.position).add(k),xf.rotation.z=Jp+Zp+(Math.random()-.5)*.001}function dm(e){if(cf===`playing`){if(qf===`idle`){if(Kf-=e,Kf<=0&&(qf=`flicker`,Jf=0,!fp)){fp=!0,Df.visible=!0;let e=new Ho(kf);e.setBuffer(Ff),e.setVolume(.7),e.play()}}else if(qf===`flicker`)Jf+=e,Jf<.3?Df.visible=!0:Jf<.6?Df.visible=!1:Jf<.9?Df.visible=!0:Jf<1.2?Df.visible=!1:(Df.visible=!0,qf=`waiting`,Jf=0);else if(qf===`waiting`){if(Jf+=e,Jf>=3){qf=`rushing`,Jf=0;let e=new W(0,0,-1).applyQuaternion(xf.getWorldQuaternion(new kt));if(e.y=0,e.normalize(),Hf&&(Hf.position.copy(Q.position).add(e.clone().multiplyScalar(8)),Hf.position.y=0,Hf.lookAt(Q.position.x,0,Q.position.z),Hf.visible=!0,Yf.copy(e).negate().normalize()),Wf){let e=new Ho(kf);e.setBuffer(Wf),e.setVolume(1),e.play()}}}else qf===`rushing`&&(Jf+=e,Hf&&Hf.position.add(Yf.clone().multiplyScalar(e*24)),Jf>=1&&(Hf&&(Hf.visible=!1),qf=`idle`,Kf=60+Math.random()*120));if(!Zf){if(Xf-=e,Xf<=0&&(Zf=!0,Xf=30+Math.random()*60,Uf)){Qf=Uf.clone(),Qf.name=`falling_scp_instance`;let e=Math.random()*Math.PI*2,t=3+Math.random()*5;Qf.position.set(Q.position.x+Math.cos(e)*t,5,Q.position.z+Math.sin(e)*t),bf.add(Qf),$f=0}}else if(Qf&&($f+=9.8*e,Qf.position.y-=$f*e,Qf.position.y<=.2)){if(Qf.position.y=.2,Zf=!1,Gf){let e=new Ho(kf);e.setBuffer(Gf),e.setVolume(.8),e.play()}Qf=null}bf.children.forEach(e=>{e.name===`falling_scp_instance`&&Q.position.distanceTo(e.position)>35&&bf.remove(e)})}}var fm=0,pm=30+Math.random()*60;function mm(e){if(cf!==`playing`||Vf||(fm+=e,fm<pm)||(fm=0,pm=30+Math.random()*60,Lf.length===0))return;let t=Lf[Math.floor(Math.random()*Lf.length)];if(!t)return;let n=Q.position.x,r=Q.position.z;if(yp.size>0){let e=Math.round(Q.position.x/vp),t=Math.round(Q.position.z/vp),i=[];for(let n of yp.keys()){let[r,a]=n.split(`,`).map(Number);(r!==e||a!==t)&&i.push(n)}if(i.length>0){let[e,t]=i[Math.floor(Math.random()*i.length)].split(`,`).map(Number);n=e*vp+(Math.random()-.5)*vp*.7,r=t*vp+(Math.random()-.5)*vp*.7}else n+=(Math.random()-.5)*20,r+=(Math.random()-.5)*20}let i=new qo(kf);i.setBuffer(t),i.setRefDistance(12),i.setRolloffFactor(.8),i.setVolume(2.4),i.position.set(n,1.5,r),bf.add(i),i.play(),i.onEnded=()=>bf.remove(i)}var hm=1e3/of,gm=performance.now(),_m=performance.now();function vm(){requestAnimationFrame(vm);let e=performance.now(),t=e-gm;if(t>hm){gm=e-t%hm;let n=Math.min((e-_m)/1e3,.1);if(_m=e,cf!==`loading`&&_p(n),cf===`playing`){lf+=n,Bp(n),um(n);let e=op-cp;e=Math.atan2(Math.sin(e),Math.cos(e)),cp+=e*.2,lp=Ot.lerp(lp,sp,.2),Sf.rotation.y=cp,pp=Ot.lerp(pp,mp,.24),xf.fov=pp,xf.updateProjectionMatrix();let t=(60-pp)/48;Df.intensity=8+t*15,Df.angle=Math.PI/3.8*(1-t*.4),Df.distance=35+t*35,Df.penumbra=.6+t*.4,up*=.96,dp*=.96,Wp(n),dm(n),mm(n),Mp()}else rp(e);let r=new W,i=new kt;xf.getWorldPosition(r),xf.getWorldQuaternion(i),Df.position.copy(r),ap.slerp(i,.12);let a=new W(0,0,-1).applyQuaternion(ap);Df.target.position.copy(r).add(a),Np.uniforms.uTime.value=e*.001%10,Np.uniforms.uBlurIntensity.value=Math.min(up+dp,2),Np.uniforms.uScreenState.value=+(cf===`playing`),Cf.setRenderTarget(Tf),Cf.render(bf,xf),Cf.setRenderTarget(null),Np.uniforms.tDiffuse.value=Tf.texture,Cf.render(Pp,Fp)}}window.addEventListener(`resize`,()=>{let e=vf();Cf.setSize(e.width,e.height),Tf.setSize(e.width,e.height)}),vm();